...
export default function StrategicHero() {
  const content = companies.find((c) => c.id === 'strategic')
    ...
    <section className="relative overflow-hidden bg-white pt-32 pb-16">
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 lg:px-8">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-[12px] font-medium text-indigo-700">
            {content.sector}
          </span>
